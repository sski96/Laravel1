        ...
        <div class="col-md-12">
          ...
          <div class="card card-info">
            <div class="card-header">
              <h3 class="card-title">Form Update Data Petugas</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Apakah Anda Yakin Akan Keluar Dari Form Update Data Petugas</p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
          <a href="{{ route('petugas.index') }}" type="button" class="btn btn-primary">Yes</a>
        </div>
      </div>
   </div>
</div>
